...
import com.microservices.demo.admin.client.KafkaAdminClient;
...
public class TwitterKafkaConsumer implements KafkaConsumer<TwitterAvroModel> {
    ...
    public void receive(@Payload List<TwitterAvroModel> messages,
        ...
        LOG.info("{} of messages received with keys {}, partition {} and offset {}, " +
            "sending it to elastic Thread name {}",
            messages.size(),
            keys.toString(),
            partitions.toString(),
            offsets.toString(),
