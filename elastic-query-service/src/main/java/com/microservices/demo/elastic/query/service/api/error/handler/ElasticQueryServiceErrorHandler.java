...
public class ElasticQueryServiceErrorHandler {
    ...
    public ResponseEntity<String> handle(IllegalArgumentException e){
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Illegal argument exception! " + e.getMessage());
    }
    ...
    public ResponseEntity<String> handle(Exception e){
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("A server error occured! " + e.getMessage());
    }
